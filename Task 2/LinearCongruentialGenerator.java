...
// Need to be long in order to hold typical values ...
  ...
  private static LinearCongruentialGenerator single_instance = null;
//sets the the single_instance variable to null

  public static LinearCongruentialGenerator getInstance() { 
        if (single_instance == null) 
            single_instance = new LinearCongruentialGenerator();
            //alows this class to become a singleton class
